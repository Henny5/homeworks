$(document).ready(function () {
  ...
  $("body")
    .append('<div id = "marker"></div><div id = "gamefield"></div>')
    .css({
  ...
  function gemSwitch() {
    ...
    $("#" + gemIdPrefix + "_" + selectedRow + "_" + selectedCol).attr(
      "id",
      "temp"
    );
    $("#" + gemIdPrefix + "_" + posY + "_" + posX).attr(
      "id",
      gemIdPrefix + "_" + selectedRow + "_" + selectedCol
    );
